...
ALTER TABLE [dbo].[RacesPoints]  WITH CHECK ADD  CONSTRAINT [FK_RacesPoints_Drivers] FOREIGN KEY([extDriver])
REFERENCES [dbo].[Drivers] ([driverNumber])

ALTER TABLE [dbo].[RacesPoints]  WITH CHECK ADD  CONSTRAINT [FK_RacesPoints_Scores] FOREIGN KEY([extPos])
